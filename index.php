...
<html>
	...
	<body>
		<div class="container" text-align="center">
			<br/>
			<h3 text-align="center">Welcome, please upload your image</h3>
			<br/>
			<a href="table.php"><h3>checkout previous images</h3></a>
			  	...
			  	<div class="modal-dialog modal-lg" role="document">
			    	<div class="modal-content">
			      		<div class="modal-header">
			        		<h5 class="modal-title" id="modalLabel">Crop Image Before Uploading it</h5>
			      		...
			      		<div class="modal-footer">
							...
							<button type="submit" name="addtopred" value="Add Image"></li>
			      		</div>
			    	</div>
			  	</div>
			</div>		
			...
			<div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
			  	<div class="modal-dialog modal-lg" role="document">
			    	<div class="modal-content">
			      		<div class="modal-header">
			        		<h5 class="modal-title" id="modalLabel">Enter Your Email</h5>
			        		<button type="button" class="close" data-dismiss="modal" aria-label="Close">
			          			<span aria-hidden="true">x</span>
			        		</button>
			      		</div>
			      		...
			      		<div class="modal-footer">
			        		<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
			        		<button type="button" class="btn btn-primary" id="crop">Send</button>
